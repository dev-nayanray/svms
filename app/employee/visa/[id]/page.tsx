  ...
  return (
    <>
      ...
      <PageHeader
        ...
        breadcrumbs={["Employee", "Visa", visa.application.applicationNumber]}
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-sm">
                <Row
                  label="Application"
                  value={
                    <Link href={`/employee/applications/${visa.application.id}`} className="font-mono text-xs text-primary hover:underline">
                      {visa.application.applicationNumber}
                    </Link>
                  }
                />
                <Row
                  label="Student"
                  value={
                    <Link href={`/employee/students/${visa.application.student.id}`} className="text-primary hover:underline">
