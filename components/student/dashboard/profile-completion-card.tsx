...
const TONE_CLASSES: Record<Tone, {
  ...
  destructive: {
    card: "border-red-300/60 bg-red-50/40 dark:bg-red-950/10",
    bar: "bg-red-500",
    icon: "bg-red-500/15 text-red-600",
    badge: "bg-red-500/10 text-red-600",
    cta: "bg-gradient-to-br from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700",
  },
  warning: {
    ...
    cta: "bg-gradient-to-br from-amber-500 to-amber-600 text-white hover:from-amber-600 hover:to-amber-700",
  },
  info: {
    card: "border-blue-300/60 bg-blue-50/40 dark:bg-blue-950/10",
    bar: "bg-blue-500",
    icon: "bg-blue-500/15 text-blue-600",
    badge: "bg-blue-500/10 text-blue-600",
    cta: "bg-gradient-to-br from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700",
  },
  success: {
    card: "border-emerald-300/60 bg-emerald-50/40 dark:bg-emerald-950/10",
    bar: "bg-emerald-500",
    icon: "bg-emerald-500/15 text-emerald-600",
    badge: "bg-emerald-500/10 text-emerald-600",
    cta: "bg-gradient-to-br from-emerald-500 to-emerald-600 text-white hover:from-emerald-600 hover:to-emerald-700",
  },
};
